...
export default function MainLeftBar({groupToColor, setTreeData, showCompleted, setShowCompleted, setLeftBarIsOpen}: {groupToColor: any, setTreeData: any; showCompleted: any; setShowCompleted: any; setLeftBarIsOpen: any}) {
     ...
     * TODO:
     * - Render commonality labels here
     * - Create rendering logic for colors in the tree, and connect to toggle
     * - Fix Completion logic for courses (MAT309 and MAT157, the MAT157 on the leaf of MAT309 should be yellow since it is ready to be taken)
     * - Do Content in degree and focus explorer
     */
    console.log(groupToColor)
